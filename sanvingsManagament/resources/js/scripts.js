...
//Valido el formulario evitando posibles datos que no sean concordantes

function isValidTransactionForm(transactionObj) {
  let isValidForm = true;
  if (!transactionObj["transactionType"]) {
    alert("Debes elegir si es ingreso o egreso!!");
    isValidForm = false;
  }
...
//creo un apartado de valoración
let btn = document.getElementById('sendButton')
    ...
    //aplico fetch y json con datos a modo de ejemplo
